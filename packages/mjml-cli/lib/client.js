...
var _default = /*#__PURE__*/(0, _asyncToGenerator2.default)(function* () {
  ...
  const _yargs$version$option = _yargs.default.version(false) // cf. https://github.com/yargs/yargs/issues/961
  .options({
    r: {
      alias: 'read',
    ...
    version: {
      alias: 'V'
        ...
        argv = _yargs$version$option.argv;
  ...
  switch (inputOpt) {
    ...
    case 'i':
      inputs.push(yield (0, _readStream.default)());
      break;
        ...
        default:
          {
            ...
            compiled = (0, _mjmlCore.default)(i.mjml, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, (0, _omit2.default)(config, ['minify', 'beautify'])), {}, {
              filePath: filePath || i.file,
              actualPath: i.file
            }));
            ...
            if (minify) {
              compiled.html = (0, _htmlMinifier.minify)(compiled.html, (0, _objectSpread2.default)({
