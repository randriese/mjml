...
let MjSection = /*#__PURE__*/function (_BodyComponent) {
  ...
  (0, _createClass2.default)(MjSection, [{
    ...
    value: function getBackgroundString() {
      const _this$getBackgroundPo = this.getBackgroundPosition(),
    ...
    value: function getBackgroundPosition() {
      const _this$parseBackground = this.parseBackgroundPosition(),
    ...
    value: function renderWithBackground(content) {
      ...
      let _this$getBackgroundPo2 = this.getBackgroundPosition(),
      ...
      <!--[if mso | IE]>
        ...
        <v:fill ${this.htmlAttributes((0, _objectSpread2.default)({
