...
(0, _each2.default)(defaultSocialNetworks, (val, key) => {
  defaultSocialNetworks[`${key}-noshare`] = (0, _objectSpread2.default)((0, _objectSpread2.default)({}, val), {}, {
    'share-url': '[[URL]]'
  });
});
...
let MjSocialElement = /*#__PURE__*/function (_BodyComponent) {
  ...
  (0, _createClass2.default)(MjSocialElement, [{
    ...
    value: function getStyles() {
      const _this$getSocialAttrib = this.getSocialAttributes(),
    ...
    value: function getSocialAttributes() {
      ...
      const attrs = ['icon-size', 'icon-height', 'srcset', 'sizes', 'src', 'background-color'].reduce((r, attr) => (0, _objectSpread2.default)((0, _objectSpread2.default)({}, r), {}, {
    ...
    value: function render() {
      const _this$getSocialAttrib2 = this.getSocialAttributes(),
