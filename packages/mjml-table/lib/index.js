...
let MjTable = /*#__PURE__*/function (_BodyComponent) {
  ...
  (0, _createClass2.default)(MjTable, [{
    ...
    value: function render() {
      const tableAttributes = (0, _reduce2.default)(['cellpadding', 'cellspacing'], (acc, v) => (0, _objectSpread2.default)((0, _objectSpread2.default)({}, acc), {}, {
        [v]: this.getAttribute(v)
      }), {});
      return `
      <table
        ${this.htmlAttributes((0, _objectSpread2.default)((0, _objectSpread2.default)({}, tableAttributes), {}, {
        width: this.getWidth(),
        border: '0',
        style: 'table'
      }))}
