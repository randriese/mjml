...
function MJMLParser(xml, options = {}, includedIn = []) {
  const _options$addEmptyAttr = options.addEmptyAttributes,
  ...
  const endingTags = (0, _flow2.default)((0, _filter2.default)(component => component.endingTag), (0, _map2.default)(component => component.getTagName()))((0, _objectSpread2.default)({}, components));
  let cwd = process.cwd();
  ...
  const handleInclude = (file, line) => {
    ...
    const partialMjml = MJMLParser(content, (0, _objectSpread2.default)((0, _objectSpread2.default)({}, options), {}, {
    ...
    const bindToTree = (children, tree = cur) => children.map(c => (0, _objectSpread2.default)((0, _objectSpread2.default)({}, c), {}, {
      parent: tree
    }));
