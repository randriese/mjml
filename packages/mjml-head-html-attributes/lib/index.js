  ...
  (0, _createClass2.default)(MjHtmlAttributes, [{
    ...
    value: function handler() {
      ...
      children.filter(c => c.tagName === 'mj-selector').forEach(selector => {
        ...
        const custom = children.filter(c => c.tagName === 'mj-html-attribute' && !!(0, _get2.default)(c, 'attributes.name')).reduce((acc, c) => (0, _objectSpread2.default)((0, _objectSpread2.default)({}, acc), {}, {
