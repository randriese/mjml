...
let MjAccordion = /*#__PURE__*/function (_BodyComponent) {
  ...
  (0, _createClass2.default)(MjAccordion, [{
    ...
    value: function render() {
      const childrenAttr = ['border', 'icon-align', 'icon-width', 'icon-height', 'icon-position', 'icon-wrapped-url', 'icon-wrapped-alt', 'icon-unwrapped-url', 'icon-unwrapped-alt'].reduce((res, val) => (0, _objectSpread2.default)((0, _objectSpread2.default)({}, res), {}, {
